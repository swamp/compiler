...
func NewExternalFunction(tokens string, parameterCount uint, posLen token.PositionLength) *ExternalFunction {
...
func (d *ExternalFunction) PositionLength() token.PositionLength {
	return d.posLen
}
