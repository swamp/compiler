...
func testHelperWithTesting(t *testing.T, document string, s string) string {
	lspService := lspservice.NewLspImpl(loader.NewFileSystemDocumentProvider(), environment.Environment{})
...
func BenchmarkDocumentSemanticSymbolsBench(b *testing.B) {
	for i := 0; i < b.N; i++ {
		testHelperWithTestingStringDoc(nil, "file:///home/peter/own/hackman/swamp/gameplay/Main.swamp",
			`{"jsonrpc":"2.0","id":2,"method":"textDocument/semanticTokens/full","params":{"textDocument":{"uri":"file:///home/peter/own/hackman/swamp/gameplay/Main.swamp"}}}`, ``)
	}
}
...
func TestDocumentSemanticSymbols5(t *testing.T) {
	testHelperWithTestingStringDoc(t, "file:///home/peter/own/hackman/swamp/render/Main.swamp",
		`{"jsonrpc":"2.0","id":3,"method":"textDocument/documentSymbol","params":{"textDocument":{"uri":"file:///home/peter/own/hackman/swamp/render/Main.swamp"}}}`, ``)
}
