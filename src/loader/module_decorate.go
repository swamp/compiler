...
func (w *WorldDecorator) RunesToModule(moduleRepository deccy.ModuleRepository, moduleName dectype.ArtifactFullyQualifiedModuleName, relativeFilename string, str string) (*decorated.Module, decshared.DecoratedError) {
	const errorsAsWarnings = false
	return deccy.InternalCompileToModule(moduleRepository, w.rootModules, w.importModules, moduleName, relativeFilename, str,
