...
func TestCustomTypeNotDefinedLocalTypeFail(t *testing.T) {
	testDecorateWithoutDefaultFail(t,
		`
type alias Lister t =
    { fake : t
...
`, &ast.UnknownTypeParameterError{})
}

func TestGenericsStructTooManyLocalTypes(t *testing.T) {
	testDecorateWithoutDefaultFail(t,
		`
type alias Tinkering t u =
    { solder : Bool
    , secret : t
    }
`, &ast.ExtraTypeParametersError{})
...
func TestGenericsStructTooManyLocalTypes2(t *testing.T) {
	testDecorateWithoutDefaultFail(t,
		`
...
`, `
[ModuleDef $initial = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [String hej]]]
[ModuleDef $first = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]] [Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> (Arithmetic [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] MULTIPLY [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]])]]
...
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [[IncompleteFnCall [FunctionRef [NamedDefinitionReference /second]] []] <| [[IncompleteFnCall [FunctionRef [NamedDefinitionReference /first]] [(Arithmetic [Integer 2] PLUS [Integer 2])]] <| [FnCall [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]] [FunctionRef [NamedDefinitionReference /initial]] [[Integer 2]]] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]])] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]])]]]
`)
}

func TestOperatorPipeLeftSingle2(t *testing.T) {
	testDecorateWithoutDefault(t,
		`
first : (a: Int, String) -> Int =
    a * a
...
tester : (String) -> Bool =
    second <| first (2 + 2) "hello"
`, `
[ModuleDef $first = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]] [Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> (Arithmetic [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] MULTIPLY [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]])]]
[ModuleDef $second = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [BoolOp [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] GR [Integer 25]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [[IncompleteFnCall [FunctionRef [NamedDefinitionReference /second]] []] <| [FnCall [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /first]] [(Arithmetic [Integer 2] PLUS [Integer 2]) [String hello]]] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]])]]]
`)
}

func TestOperatorTwoPipeLeft3(t *testing.T) {
	testDecorateWithoutDefault(t,
		`
first : (a: Int, String) -> Int =
    a * a
...
[ModuleDef $first = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]] [Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> (Arithmetic [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] MULTIPLY [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]])]]
[ModuleDef $second = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [BoolOp [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] GR [Integer 25]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [[IncompleteFnCall [FunctionRef [NamedDefinitionReference /second]] []] <| [[IncompleteFnCall [FunctionRef [NamedDefinitionReference /first]] [(Arithmetic [Integer 2] PLUS [Integer 2])]] <| [String hello] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]])] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]])]]]
`)
}
...
func TestOperatorPipeRightNextLine(t *testing.T) {
	testDecorateWithoutDefault(t,
		`
first : (a: Int) -> Int =
    a * a
...
[ModuleDef $first = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> (Arithmetic [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] MULTIPLY [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]])]]
[ModuleDef $second = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [BoolOp [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] GR [Integer 25]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /first]] [(Arithmetic [Integer 2] PLUS [Integer 2])]] |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference /second]] []] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]])]]
`)
}
...
[ModuleDef $a = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]] [TupleType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]]) -> [FnCall [FunctionType [[Primitive Int] [Primitive String] [TupleType [[ConcreteGenericRef [LocalTypeNameRef a] => [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]] [ConcreteGenericRef [LocalTypeNameRef b] => [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]]]] [FunctionRef [NamedDefinitionReference /createTuple]] [[Integer 2] [String Hello]]]]]
`)
}
...
func TestTypeRefPipeRight(t *testing.T) {
	testDecorateWithoutDefault(t,
		`
haveStringAsParameter : (String) -> Int
...
`, `
[ModuleDef $haveStringAsParameter = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [ExternalFunctionDeclarationExpression [FnDeclExpr 0] [Primitive Any]]]]
[ModuleDef $another = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [Bool true]]]
[ModuleDef $main = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([]) -> [FnCall [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /haveStringAsParameter]] [[String hi]]] |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference /another]] []] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]])]]
  `)
}

func TestTypeRefPipeRight3(t *testing.T) {
	testDecorateWithoutDefault(t,
		`
type alias GoldPrice = Int


somethingElse : (_: String, _: List GoldPrice) -> Int =
    23


haveTypeRefAsParameter : (TypeRef a) -> List a


main : Int =
    haveTypeRefAsParameter $GoldPrice |> somethingElse "hello"
`, `
GoldPrice : [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]

[ModuleDef $somethingElse = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [ResolvedContext a:[AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]] [Param $_ : [ResolvedContext a:[AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]]) -> [Integer 23]]]
[ModuleDef $haveTypeRefAsParameter = [FunctionValue [LocalTypeNameOnlyContext a => [FunctionType [[ResolvedContext a:[LocalTypeNameRef a] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $TypeRef]] [LocalTypeNameOnlyContext a => [Primitive TypeRef<[LocalTypeNameRef a]>]]]] [ResolvedContext a:[LocalTypeNameRef a] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]]] ([[Param $_ : [ResolvedContext a:[LocalTypeNameRef a] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $TypeRef]] [LocalTypeNameOnlyContext a => [Primitive TypeRef<[LocalTypeNameRef a]>]]]]]]) -> [ExternalFunctionDeclarationExpression [FnDeclExpr 0] [Primitive Any]]]]
[ModuleDef $main = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([]) -> [FnCall [FunctionType [[Primitive TypeRef<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]>] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]>]]] [FunctionRef [NamedDefinitionReference /haveTypeRefAsParameter]] [[TypeIdLiteral [ResolvedContext a:[AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $TypeRef]] [LocalTypeNameOnlyContext a => [Primitive TypeRef<[LocalTypeNameRef a]>]]]]]]] |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference /somethingElse]] [[String hello]]] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]])]]
`)
}
...
[ModuleDef $main = [FunctionValue [FunctionType [[AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]] ([]) -> [FnCall [FunctionType [[Primitive TypeRef<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]>] [CustomType Maybe [[Variant $Nothing] [Variant $Just [[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]]]] [FunctionRef [NamedDefinitionReference /haveTypeRefAsParameter]] [[TypeIdLiteral [ResolvedContext a:[AliasRef [Alias GoldPrice [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $TypeRef]] [LocalTypeNameOnlyContext a => [Primitive TypeRef<[LocalTypeNameRef a]>]]]]]]] |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference Maybe/withDefault]] [[Integer 0]]] ([Primitive Int])]]
`)
}

func TestTwoPipeRight(t *testing.T) {
	testDecorateWithoutDefault(t,
		`
first : (a: Int) -> Int =
    a * a
...
third : (a: Bool) -> String =
    if a then "worked" else "not"


tester : (b: String) -> String =
...
[ModuleDef $third = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]]) -> [If [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] then [String worked] else [String not]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]] ([[Param $b : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /first]] [(Arithmetic [Integer 2] PLUS [Integer 2])]] |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference /second]] [[ParamRef [Param $b : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]]] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]) |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference /third]] []] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]])]]
 `)
}

func TestTwoPipeRight2(t *testing.T) {
	testDecorateWithoutDefault(t, `
first : (Int) -> Int =
    2
...
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]] ([[Param $b : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /first]] [(Arithmetic [Integer 2] PLUS [Integer 2])]] |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference /second]] [[ParamRef [Param $b : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]]] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]) |> [IncompleteFnCall [FunctionRef [NamedDefinitionReference /third]] []] ([PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]])]]
`)
}
...
func TestConcatMapWithCurry(t *testing.T) {
	testDecorate(t, `
type alias Runway =
    { secret : Int
    }
...
third : (_: String, a: Int) -> List Runway =
    [ Runway a ]


tester : (_: String) -> List Runway =
    List.concatMap (third "save this") [ 1, 2, 3, 4 ]
`, `
Runway : [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]

[ModuleDef $third = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]] [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [ListLiteral [[record-constructor [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] [0 = [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[FunctionType [[Primitive Int] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef b] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>]]] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]>] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef b] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>]]] [FunctionRef [NamedDefinitionReference List/concatMap]] [[Curry [FunctionRef [NamedDefinitionReference /third]] [[String save this]]] [ListLiteral [[Integer 1] [Integer 2] [Integer 3] [Integer 4]]]]]]]
`)
}

func TestConcatMap2(t *testing.T) {
	testDecorate(t, `
type alias Runway =
    { secret : Int
    }
...
third : (a: Int) -> List Runway =
    [ Runway a ]


tester : (_: String) -> List Runway =
    List.concatMap third [ 1, 2, 3, 4 ]
`, `
Runway : [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]

[ModuleDef $third = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [ListLiteral [[record-constructor [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] [0 = [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[FunctionType [[Primitive Int] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef b] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>]]] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]>] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef b] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>]]] [FunctionRef [NamedDefinitionReference List/concatMap]] [[FunctionRef [NamedDefinitionReference /third]] [ListLiteral [[Integer 1] [Integer 2] [Integer 3] [Integer 4]]]]]]]
`)
}

func TestOwnMapping2(t *testing.T) {
	testDecorate(t, `
type alias Runway =
    { secret : Int
    }
...
[ModuleDef $mapping = [FunctionValue [LocalTypeNameOnlyContext a, b => [FunctionType [[FunctionType [[LocalTypeNameRef a] [LocalTypeNameRef b]]] [LocalTypeNameRef a]]]] ([[Param $_ : [FunctionType [[LocalTypeNameRef a] [LocalTypeNameRef b]]]]]) -> [ExternalFunctionDeclarationExpression [FnDeclExpr 0] [Primitive Any]]]]
[ModuleDef $third = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [ListLiteral [[record-constructor [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] [0 = [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[FunctionType [[Primitive Int] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]>]]] [Primitive Int]]] [FunctionRef [NamedDefinitionReference /mapping]] [[FunctionRef [NamedDefinitionReference /third]]]]]]
`)
}

func TestOwnMapping3(t *testing.T) {
	testDecorateWithoutDefault(t, `
type alias Runway =
    { secret : Int
    }
...
tester : (_: String) -> Runway =
    mapping third
`, `
Runway : [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]

[ModuleDef $mapping = [FunctionValue [LocalTypeNameOnlyContext a, b => [FunctionType [[FunctionType [[LocalTypeNameRef a] [ResolvedContext a:[LocalTypeNameRef b] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] [LocalTypeNameRef b]]]] ([[Param $_ : [FunctionType [[LocalTypeNameRef a] [ResolvedContext a:[LocalTypeNameRef b] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]]]]) -> [ExternalFunctionDeclarationExpression [FnDeclExpr 0] [Primitive Any]]]]
[ModuleDef $third = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [ListLiteral [[record-constructor [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] [0 = [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[FunctionType [[Primitive Int] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef b] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>]]] [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] [FunctionRef [NamedDefinitionReference /mapping]] [[FunctionRef [NamedDefinitionReference /third]]]]]]
`)
}

func TestOwnMapping4(t *testing.T) {
	testDecorateWithoutDefault(t, `
type alias Runway =
    { secret : Int
    }
...
__externalvarfn mapping : ((a -> List b)) -> List a
...
tester : (_: String) -> List Int =
    mapping third
`, `
Runway : [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]

[ModuleDef $mapping = [FunctionValue [LocalTypeNameOnlyContext a, b => [FunctionType [[FunctionType [[LocalTypeNameRef a] [ResolvedContext a:[LocalTypeNameRef b] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] [ResolvedContext a:[LocalTypeNameRef a] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]]] ([[Param $_ : [FunctionType [[LocalTypeNameRef a] [ResolvedContext a:[LocalTypeNameRef b] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]]]]) -> [ExternalFunctionDeclarationExpression [FnDeclExpr 2] [Primitive Any]]]]
[ModuleDef $third = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [ListLiteral [[record-constructor [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] [0 = [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[FunctionType [[Primitive Int] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef b] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>]]] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]>]]] [FunctionRef [NamedDefinitionReference /mapping]] [[FunctionRef [NamedDefinitionReference /third]]]]]]
`)
}

func TestOwnMapping5(t *testing.T) {
	testDecorateWithoutDefault(t, `
type alias Runway =
    { secret : Int
    }
...
[ModuleDef $mapping = [FunctionValue [LocalTypeNameOnlyContext a, b => [FunctionType [[FunctionType [[LocalTypeNameRef a] [ResolvedContext a:[LocalTypeNameRef b] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] [LocalTypeNameRef a]]]] ([[Param $_ : [FunctionType [[LocalTypeNameRef a] [ResolvedContext a:[LocalTypeNameRef b] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]]]]) -> [ExternalFunctionDeclarationExpression [FnDeclExpr 0] [Primitive Any]]]]
[ModuleDef $third = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [ResolvedContext a:[AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]]]] ([[Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]) -> [ListLiteral [[record-constructor [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] [0 = [ParamRef [Param $a : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]]
[ModuleDef $tester = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $String]]]]]) -> [FnCall [FunctionType [[FunctionType [[Primitive Int] [Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef b] => [AliasRef [Alias Runway [RecordType [[Field $secret [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>]]] [Primitive Int]]] [FunctionRef [NamedDefinitionReference /mapping]] [[FunctionRef [NamedDefinitionReference /third]]]]]]
`)
}

func TestOwnMappingFail(t *testing.T) {
	testDecorateWithoutDefaultFail(t, `
type alias Runway =
    { secret : Int
    }
...
[ModuleDef $simple = [FunctionValue [LocalTypeNameOnlyContext a => [FunctionType [[LocalTypeNameRef a] [FunctionType [[LocalTypeNameRef a] [LocalTypeNameRef a]]]]]] ([[Param $_ : [LocalTypeNameRef a]]]) -> [FunctionRef [NamedDefinitionReference /intConvert]]]]
[ModuleDef $main = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]]) -> [Let [[LetAssign [[LetVar $fn]] = [FnCall [FunctionType [[Primitive Int] [FunctionType [[Primitive Int] [Primitive Int]]]]] [FunctionRef [NamedDefinitionReference /simple]] [[Integer 33]]]]] in [FnCall [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /intConvert]] [[FnCall [FunctionType [[Primitive Int] [Primitive Int]]] [LetVarRef $fn] [[Integer 22]]]]]]]]
`)
}
...
UserInput : [Alias UserInput [RecordType [[Field $gamepads [ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] (0)]]]]
PlayerInputs : [Alias PlayerInputs [RecordType [[Field $inputs [ResolvedContext a:[CustomTypeRef [NamedDefTypeRef :[TypeReference $PlayerAction]] [CustomType PlayerAction [[Variant $None] [Variant $Jump]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]] (0)]]]]

[ModuleDef $checkMaybeGamepad = [FunctionValue [FunctionType [[ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Maybe]] [LocalTypeNameOnlyContext a => [CustomType Maybe [[Variant $Nothing] [Variant $Just [[LocalTypeNameRef a]]]]]]]] [CustomTypeRef [NamedDefTypeRef :[TypeReference $PlayerAction]] [CustomType PlayerAction [[Variant $None] [Variant $Jump]]]]]] ([[Param $_ : [ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Maybe]] [LocalTypeNameOnlyContext a => [CustomType Maybe [[Variant $Nothing] [Variant $Just [[LocalTypeNameRef a]]]]]]]]]]) -> [VariantConstructor [Variant $None] []]]]
[ModuleDef $main = [FunctionValue [FunctionType [[AliasRef [Alias UserInput [RecordType [[Field $gamepads [ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] (0)]]]]] [AliasRef [Alias PlayerInputs [RecordType [[Field $inputs [ResolvedContext a:[CustomTypeRef [NamedDefTypeRef :[TypeReference $PlayerAction]] [CustomType PlayerAction [[Variant $None] [Variant $Jump]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]] (0)]]]]]]] ([[Param $oldUserInputs : [AliasRef [Alias UserInput [RecordType [[Field $gamepads [ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] (0)]]]]]]]) -> [Let [[LetAssign [[LetVar $gamepads]] = [lookups [ParamRef [Param $oldUserInputs : [AliasRef [Alias UserInput [RecordType [[Field $gamepads [ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] (0)]]]]]]] [[lookup [Field $gamepads [ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] (0)]]]]] [LetAssign [[LetVar $maybeOld]] = [FnCall [FunctionType [[Primitive Int] [Primitive Array<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]>] [CustomType Maybe [[Variant $Nothing] [Variant $Just [[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]]]]]]]]]] [FunctionRef [NamedDefinitionReference Array/get]] [[Integer 0] [LetVarRef $gamepads]]]] [LetAssign [[LetVar $playerAction]] = [FnCall [FunctionType [[ResolvedContext a:[AliasRef [Alias Gamepad [RecordType [[Field $a [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] (0)]]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Maybe]] [LocalTypeNameOnlyContext a => [CustomType Maybe [[Variant $Nothing] [Variant $Just [[LocalTypeNameRef a]]]]]]]] [CustomTypeRef [NamedDefTypeRef :[TypeReference $PlayerAction]] [CustomType PlayerAction [[Variant $None] [Variant $Jump]]]]]] [FunctionRef [NamedDefinitionReference /checkMaybeGamepad]] [[LetVarRef $maybeOld]]]]] in [RecordLiteral [RecordType [[Field $inputs [ResolvedContext a:[CustomTypeRef [NamedDefTypeRef :[TypeReference $PlayerAction]] [CustomType PlayerAction [[Variant $None] [Variant $Jump]]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $List]] [LocalTypeNameOnlyContext a => [Primitive List<[LocalTypeNameRef a]>]]]] (0)]]] [0 = [ListLiteral [[LetVarRef $playerAction]]]]]]]]
`)
}
...
`,
		`
[ModuleDef $getInt = [FunctionValue [FunctionType [[ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Maybe]] [LocalTypeNameOnlyContext a => [CustomType Maybe [[Variant $Nothing] [Variant $Just [[LocalTypeNameRef a]]]]]]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Maybe]] [LocalTypeNameOnlyContext a => [CustomType Maybe [[Variant $Nothing] [Variant $Just [[LocalTypeNameRef a]]]]]]]]]]) -> [Integer 22]]]
[ModuleDef $main = [FunctionValue [FunctionType [[ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $ints : [ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]]]]) -> [Let [[LetAssign [[LetVar $maybeInt]] = [FnCall [FunctionType [[Primitive Int] [Primitive Array<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]>] [CustomType Maybe [[Variant $Nothing] [Variant $Just [[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]]]]]]]] [FunctionRef [NamedDefinitionReference Array/get]] [[Integer 0] [ParamRef [Param $ints : [ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]]]]]]] [LetAssign [[LetVar $extractedInt]] = [FnCall [FunctionType [[ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Maybe]] [LocalTypeNameOnlyContext a => [CustomType Maybe [[Variant $Nothing] [Variant $Just [[LocalTypeNameRef a]]]]]]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /getInt]] [[LetVarRef $maybeInt]]]]] in [LetVarRef $extractedInt]]]]
`)
}
...
`,
		`
[ModuleDef $needInputs = [FunctionValue [FunctionType [[ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]]]]) -> [Integer 2]]]
[ModuleDef $a = [FunctionValue [FunctionType [[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] ([[Param $_ : [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Bool]]]]]) -> [FnCall [FunctionType [[ResolvedContext a:[PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]] => [LocalTypeNameOnlyContextReference [NamedDefTypeRef :[TypeReference $Array]] [LocalTypeNameOnlyContext a => [Primitive Array<[LocalTypeNameRef a]>]]]] [PrimitiveTypeRef [NamedDefTypeRef :[TypeReference $Int]]]]] [FunctionRef [NamedDefinitionReference /needInputs]] [[FnCall [FunctionType [[Primitive List<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [Primitive Any]]]>] [Primitive Array<[ConcreteGenericRef [LocalTypeNameRef a] => [ConcreteGenericRef [LocalTypeNameRef a] => [Primitive Any]]]>]]] [FunctionRef [NamedDefinitionReference Array/fromList]] [[ListLiteral []]]]]]]]
`)
}
