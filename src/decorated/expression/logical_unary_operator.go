...
func NewLogicalUnaryOperator(unary *ast.UnaryExpression, left DecoratedExpression, operatorType LogicalUnaryOperatorType) (*LogicalUnaryOperator, decshared.DecoratedError) {
